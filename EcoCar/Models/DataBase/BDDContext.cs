    ...
    public class BddContext : DbContext
    {
        ...
        public void InitializeDb()
        {
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 06, 25, 8,30,00),
                End = new DateTime(2022, 06, 25,16,30,00),
                IsRequest = false,
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 07, 01,15,50,00),
                End = new DateTime(2022, 07, 01,21,50,00),
                IsRequest = false,
                SelectServiceType = Service.ServiceType.CarPoolingService,
                PriceEcoCoins = 15,
                UserProviderId = 3
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 07, 07,10,15,00),
                End = new DateTime(2022, 07, 07,18,15,00),
                IsRequest = false,
                SelectServiceType = Service.ServiceType.CarPoolingService,
                PriceEcoCoins = 20,
                UserProviderId = 10
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 06, 25,15,10,00),
                End = new DateTime(2022, 06, 25,19,10,00),
                IsRequest = false,
                SelectServiceType = Service.ServiceType.CarPoolingService,
                PriceEcoCoins = 15,
                UserProviderId = 4
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 07, 01,11,00,00),
                End = new DateTime(2022, 07, 01, 15, 00, 00),
                IsRequest = false,
                SelectServiceType = Service.ServiceType.CarPoolingService,
                PriceEcoCoins = 8,
                UserProviderId = 5
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 07, 15,17, 20, 00),
                End = new DateTime(2022, 07, 15,21,20,00),
                IsRequest = false,
                SelectServiceType = Service.ServiceType.CarPoolingService,
                PriceEcoCoins = 30,
                UserProviderId = 2
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 07, 13,6, 15, 00),
                End = new DateTime(2022, 07, 13,18, 00, 00),
                IsRequest = false,
                SelectServiceType = Service.ServiceType.CarPoolingService,
                PriceEcoCoins = 35,
                UserProviderId = 6
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 06, 25,5,45,00),
                End = new DateTime(2022, 06, 25,7,45,00),
                IsRequest = false,
                SelectServiceType = Service.ServiceType.CarPoolingService,
                PriceEcoCoins = 30,
                UserProviderId = 7
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 06, 25, 14, 40, 00),
                End = new DateTime(2022, 06, 25, 16, 40, 00),
                IsRequest = true,
                SelectServiceType = Service.ServiceType.CarPoolingService,
                PriceEcoCoins = 10,
                UserProviderId = 4
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 06, 27, 17, 5, 00),
                End = new DateTime(2022, 06, 27, 19, 5, 00),
                IsRequest = true,
                SelectServiceType = Service.ServiceType.CarPoolingService,
                PriceEcoCoins = 5,
                UserProviderId = 8
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 06, 27, 13,40,00),
                End = new DateTime(2022, 06, 27, 15, 40, 00),
                IsRequest = false,
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 06, 26, 12, 40, 00),
                End = new DateTime(2022, 06, 28,13, 40, 00),
                IsRequest = false,
                SelectServiceType = Service.ServiceType.ParcelService,
                PriceEcoCoins = 10,
                UserProviderId = 10
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 07, 05, 9, 35, 00),
                End = new DateTime(2022, 07, 07, 10,35,00),
                IsRequest = true,
                SelectServiceType = Service.ServiceType.ParcelService,
                PriceEcoCoins = 9,
                UserProviderId = 10
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 06, 25, 11, 20, 00),
                End = new DateTime(2022, 06, 30, 12,20,00),
                IsRequest = false,
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 06, 30,10,00,00),
                End = new DateTime(2022, 07, 05,11,00,00),
                IsRequest = false,
                SelectServiceType = Service.ServiceType.CarRentalService,
                PriceEcoCoins = 35,
                UserProviderId = 13
            ...
            new Service
            {
                ...
                IsAvailable = true,
                Start = new DateTime(2022, 07, 10,17,30,00),
                End = new DateTime(2022, 07, 15,18,30,00),
                IsRequest = true,
                SelectServiceType = Service.ServiceType.CarRentalService,
                PriceEcoCoins = 25,
                UserProviderId = 12
